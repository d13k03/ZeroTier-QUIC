...
ifeq ($(ZT_SSO_SUPPORTED), 1)
	ifeq ($(ZT_EMBEDDED),)
		...
		ifeq ($(ZT_DEBUG),1)
			LDLIBS+=zeroidc/target/x86_64-unknown-linux-gnu/debug/libzeroidc.a -ldl -lssl -lcrypto
		else
			LDLIBS+=zeroidc/target/x86_64-unknown-linux-gnu/release/libzeroidc.a -ldl -lssl -lcrypto
		endif
	endif
endif
